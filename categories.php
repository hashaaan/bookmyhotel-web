...
?>
    ...
    <section class="contentSection" id="catagories">
        ...
        <!-- <div class="pageNav">
            <button class="navbtn previous" disabled>Previous</button>
            <button class="countbtn">1</button>
            <button class="countbtn">2</button>
            <button class="countbtn">3</button>
            <button class="countbtn">4</button>
            <button class="navbtn next">Next</button>
        </div> -->
    </section>
<?php
